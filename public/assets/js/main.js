(function ($) {
    ...
    heroSlider.owlCarousel({
        ...
        nav: true,
        navText: [
            "<i class='swiper-button-prev flex justify-content-center align-items-center' style=''></i>",
            "<i class='swiper-button-next flex justify-content-center align-items-center' style=''></i>",
