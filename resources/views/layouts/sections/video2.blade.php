        ...
        <div class="row">
            <div class="man-desktop col-lg-6 col-md-6">
                <div class="video2-popup bg-gradient-1">
                    <a href="@lang('#video2 url-video')" class="popup-youtube">
                        <i class="icofont icofont-ui-play bg-gradient-2"></i></a>
                </div>
                &nbsp;<br>
            </div>
            <div class="col-lg-6 col-md-6">
                <h1>@lang('#video2 title', ['fullname' => __('#fullname')])</h1>
                <h5 style="text-align:justify;margin-top:1rem;font-weight:400">@lang('#video2 content')</h5>
            </div>
            <div class="col-lg-12" style="padding:3.5em 0 0">
                <a class="btn btn-white" href="#">@lang('#video2 button')</a>
            </div>
        </div>
    </div>
</section>
